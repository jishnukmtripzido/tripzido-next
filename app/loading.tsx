...
//       {/* ── Scooter track ── */}
//       <div className="w-[280px] overflow-hidden relative h-[72px]">
//         <div className="absolute bottom-1 animate-[ride_2s_linear_infinite]">
...
//         <div className="animate-[roadScroll_.55s_linear_infinite] flex gap-5" style={{ width: "400px" }}>
//           {Array.from({ length: 6 }).map((_, i) => (
//             <div key={i} className="w-10 h-0.5 shrink-0 rounded-full bg-gray-200" />
//           ))}
//         </div>
//       </div>
...
//         <span className="w-1.5 h-1.5 rounded-full bg-gray-300 animate-[dotFade_1.4s_ease-in-out_infinite]" />
//         <span className="w-1.5 h-1.5 rounded-full bg-gray-300 animate-[dotFade_1.4s_ease-in-out_infinite_200ms]" />
//         <span className="w-1.5 h-1.5 rounded-full bg-gray-300 animate-[dotFade_1.4s_ease-in-out_infinite_400ms]" />
//       </div> */}
