...
export default function OffersSection() {
  ...
  const maxIndex = OFFERS.length - VISIBLE;
  ...
  function setCardWidths() {
    ...
    const gap = 16;
    const cardW =
      (viewportRef.current.offsetWidth - gap * (VISIBLE - 1)) / VISIBLE;
  ...
  return (
    <section className="px-4 lg:px-8 py-12 mx-auto xl:mx-[121.5px] xl:px-0">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          href="#"
          className="hidden md:block text-[#006CE4] font-semibold text-sm hover:underline shrink-0 ml-4"
        >
      ...
      <div className="relative group">
        {/* Scroll wrapper — overflow-x:auto on mobile, hidden on md+ */}
        <div
          ref={viewportRef}
          ...
          >
            {OFFERS.map((offer) =>
              offer.featured ? (
                <div
                  key={offer.id}
                  className="bg-[#ffc107] rounded-xl p-4 h-28 flex flex-col justify-between flex-shrink-0 min-w-[260px] md:min-w-0"
                >
                  <div>
                ...
                <div
                  key={offer.id}
                  className="bg-white border border-gray-300 rounded-xl p-4 h-28 flex flex-col justify-between hover:shadow-md transition-shadow flex-shrink-0 min-w-[260px] md:min-w-0"
                >
                  <div>
      ...
      <Link
        href="#"
        className="md:hidden block text-[#006CE4] font-semibold text-sm hover:underline mt-4"
      >
        Learn more about your offers
      </Link>
    </section>
