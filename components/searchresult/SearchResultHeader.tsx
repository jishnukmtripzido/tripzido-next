...
export default function SearchResultHeader({
  ...
  return (
    <div className="hidden md:block  top-0 z-50">

      {/* Yellow header band — pb-[52px] makes room so widget overlaps exactly halfway */}
      {/* <header className="w-full bg-[#ffc107] pb-[52px] border-b border-gray-300"> */}
      <header className="w-full bg-white  pb-[52px] border-b border-gray-300">
        <div className="mx-auto px-4 xl:mx-[121.5px] xl:px-0 flex items-center justify-between h-14">
          ...
          {/* <div className="flex items-center space-x-10">
            ...
            <nav className="flex items-center space-x-7 text-sm font-medium text-black/70">
              <Link href="#" className="flex items-center space-x-1.5 hover:text-black transition-colors">
...
<div className="flex items-center space-x-12">
          ...
          {/* Nav Links — hidden on small screens, shown on md+ but this whole header is md:hidden so nav never shows here */}
      ...
      {/* Search widget — -mt-[52px] pulls it up so it straddles the header's bottom edge exactly */}
