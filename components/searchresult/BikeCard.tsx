      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow [backface-visibility:hidden] flex flex-col pt-4">
          ...
          <div className="px-4 pb-4 flex flex-col flex-1 justify-between">
            ...
            {/* 3 Quick Specs Row */}
            <div className="flex justify-between items-center text-black text-[11px] font-thin px-1">
            ...
            <div className="relative mt-3">
              ...
              <div className="relative">
                <select className="w-full border border-gray-200 rounded-md py-1.5 pl-3 pr-8 text-xs font-thin text-black bg-white hover:border-gray-300 focus:outline-none focus:border-[#ffc107] focus:ring-1 focus:ring-[#ffc107] appearance-none cursor-pointer transition-colors">
