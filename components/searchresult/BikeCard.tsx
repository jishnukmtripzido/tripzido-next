...
//   return (
//     <div className="px-2 sm:px-0 group relative w-full max-w-sm h-[410px] bg-transparent" >
...
//               {/* Quick specs */}
//               <div className="flex justify-between items-center text-black text-[13px] font-medium sm:font-thin px-1">
...
{selectedLocation.pay_at_pickup_enabled && (
  <span className="inline-flex mr-1 items-center gap-1.5 bg-green-700 text-white text-[11px] font-medium px-1 py-1 rounded mb-2">
...
{selectedLocation.pay_at_pickup_enabled && (
  <span className="inline-flex items-center gap-1.5 bg-brand-yellow text-[#6b3d00] text-[11px] font-medium px-1 py-1 rounded mb-2">
    {/* <span className="w-1.5 h-1.5 rounded-full bg-green-700 inline-block" /> */}
    Electric
  </span>
)}
              ...
              <div className="grid grid-cols-[1fr_130px] gap-2.5 items-start">
                ...
                {/* View specs button — commented out
                <button
                  onClick={() => setIsFlipped(true)}
                  className="text-[11px] text-gray-500 border border-gray-200 rounded-full px-3 py-0.5 hover:border-[#ffc107] hover:text-black transition-colors whitespace-nowrap"
                >
                  View specs
                </button>
                */}
              ...
              >
                ...
                >
                  ...
                  <svg
                    className={`shrink-0 transition-transform duration-200 ${dropdownOpen ? "rotate-180 text-[#ffc107]" : "text-gray-300"}`}
                    ...
                    >
                      {locations.map((loc) => {
                        ...
                        return (
                          ...
                          >
                            <svg className="text-[#ffc107] shrink-0" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                              <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" strokeLinecap="round" strokeLinejoin="round" />
                              <circle cx="12" cy="10" r="3" />
                            </svg>
                            <span className="flex-1 truncate">{loc.location_name}</span>
