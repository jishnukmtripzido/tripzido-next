...
export default function SearchResultHeaderSmallScreen() {
  return (
    <header className="md:hidden w-full px-0 py-2 border-b border-gray-100 shadow-sm">
      <div className="mx-auto px-4 lg:px-8 py-2 flex items-center justify-between xl:mx-[121.5px] xl:px-0">
        {/* Left: Logo only (nav is hidden on small screens anyway) */}
        ...
        <div className="flex items-center space-x-6 text-sm font-medium">
          ...
          <div className="flex items-center space-x-3 cursor-pointer">
            <div className="w-10 h-10 rounded-full bg-[#ffc107] flex items-center justify-center text-white font-bold">
              R
            </div>
