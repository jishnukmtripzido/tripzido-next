...
export default function MobileSearchBar({
  ...
  return (
    ...
    >
      <button
        onClick={onModify}
        className="w-full bg-white flex items-center gap-3 border-1 border-[#806104] rounded-xl px-3 py-2.5 bg-white hover:border-[#ffc107] transition-colors text-left cursor-pointer"
      >
