...
export default function SearchResultHeader({
  ...
  return (
    <>
      <div className="hidden md:block top-0 z-50 bg-[#FAFBFD]">
        <header className="w-full bg-white pb-[40px] border-b border-gray-300/80  text-gray-900">
          <div className="mx-auto px-4 xl:mx-[80.5px] xl:px-0 flex items-center justify-between h-16">
            <div className="flex items-center space-x-12">
              <Link href="/" >
              <div className="flex items-center space-x-2">
                <div className="bg-[#ffc107] p-1.5 rounded-lg">
        ...
        {/* SEARCH WIDGET */}
        <section className="relative z-20 px-4 lg:px-8 -mt-[28px] mx-auto xl:mx-[80.5px] xl:px-0">
          <div>
            <div className="flex w-full items-center bg-white border-2 border-[#cccce6] rounded-md h-[52px] shadow-md">
              ...
              <div
                ...
                className={`flex-1 min-w-[110px] flex items-center px-3 h-full border-r hover:bg-gray-50 cursor-pointer transition-colors
              ...
              <div
                ...
                className="w-[140px] shrink-0 flex items-center px-3 h-full border-r border-gray-300 hover:bg-gray-50 cursor-pointer transition-colors"
              >
                <svg className="w-6 h-6 text-gray-500 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              ...
              <div
                ...
                className="w-[140px] shrink-0 flex items-center px-3 h-full hover:bg-gray-50 cursor-pointer transition-colors"
              >
                <svg className="w-6 h-6 text-gray-500 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
