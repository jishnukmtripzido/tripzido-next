...
//                 <div
//                   className={`w-${userNameFirstLetterSize || 8} h-${userNameFirstLetterSize || 8} rounded-full bg-[#ffc107] flex items-center justify-center text-white font-bold`}
//                 >
//                   {userNameFirstLetter || "J"}
//                 </div>
//                 <div className="hidden sm:block text-sm font-bold">Your account</div>
//               </div>
//             ) : (
          ...
          <div className="flex items-center space-x-3 text-sm font-medium">
            ...
            {isLoggedIn ? (
              ...
              <div className="relative hidden md:block" ref={dropdownRef}>
                ...
                >
                  <div
                    className={`w-${userNameFirstLetterSize || 8} h-${userNameFirstLetterSize || 8} rounded-full bg-[#ffc107] flex items-center justify-center text-white font-bold ring-2 ring-transparent group-hover:ring-amber-200 transition-all`}
                  >
                    {userNameFirstLetter || "J"}
                  </div>
