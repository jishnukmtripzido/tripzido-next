...
//                 >
//                   <svg
//                     className={`w-${linkIconsSize || 5} h-${linkIconsSize || 5}`}
//                     fill="none"
//                     stroke="currentColor"
//                     viewBox="0 0 24 24"
//                   >
//                     {/* Reuse the same icon paths */}
//                   </svg>
//                   <div className="flex items-center space-x-2">{link.icon}<span>{link.label}</span></div>
//                 </Link>
//               ))}
//             </nav>
//           </div>

//           {/* Right: Flag, Help, Account (desktop) + Hamburger (mobile) */}
//           <div className="flex items-center space-x-4 text-sm font-medium">
//             {/* Indian Flag */}
//             <div className="w-6 h-4 bg-gray-200 overflow-hidden rounded-sm cursor-pointer border border-gray-300 hidden sm:block">
...
//               <div
//                 className={`w-${userNameFirstLetterSize || 8} h-${
//                   userNameFirstLetterSize || 8
//                 } rounded-full bg-[#ffc107] flex items-center justify-center text-white font-bold`}
//               >
