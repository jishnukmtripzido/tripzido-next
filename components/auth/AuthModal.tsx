    ...
    <div className="  flex items-center justify-center px-4 py-5 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        {/* <div className="flex items-center justify-center gap-2.5 mb-7">
          <div className="w-9 h-9 rounded-lg bg-[#ffc107] flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
          ...
          {status === "sent" ? (
            <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-xl p-4 mb-5">
              <div className="w-9 h-9 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M20 6L9 17l-5-5" />
                </svg>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-green-800">OTP sent!</p>
              ...
              <button
                ...
                className="flex-shrink-0 text-xs font-semibold text-[#92400e] bg-[#fff8e1] border border-[#f0e8c8] rounded-md px-2.5 py-1.5 hover:bg-[#ffc107]/20 transition-colors"
              >
                Resend
              </button>
            </div>
              ...
              {page === "register" && (
                <div className=" mb-5">
                  <input
                    ...
                    className="w-full mb-5 h-11 border border-gray-300 rounded-xl px-3 text-sm text-[#1a1a1a] placeholder-gray-400 outline-none focus:border-[#ffc107] focus:ring-2 focus:ring-[#ffc107]/20 transition"
                  />
                  <input
                    type="text"
                    ...
                    className="w-full h-11 border border-gray-300 rounded-xl px-3 text-sm text-[#1a1a1a] placeholder-gray-400 outline-none focus:border-[#ffc107] focus:ring-2 focus:ring-[#ffc107]/20 transition"
                  />
                </div>
              )}
              ...
              <div className="mb-5">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="w-24 h-[46px] flex-shrink-0 border border-gray-300 rounded-xl bg-gray-50 text-sm text-[#1a1a1a] px-2 outline-none focus:border-[#ffc107] focus:ring-2 focus:ring-[#ffc107]/20 transition cursor-pointer"
                  >
                    {COUNTRY_CODES.map((c) => (
                  ...
                  <input
                    ...
                    className={`flex-1 h-[46px] border rounded-xl px-3.5 text-[15px] text-[#1a1a1a] placeholder-gray-400 outline-none transition
                      ${error
                        ...
                        : "border-gray-300 focus:border-[#ffc107] focus:ring-2 focus:ring-[#ffc107]/20"
                      }`}
                  />
                </div>
                {error && (
              ...
              <button
                ...
                className={`w-full h-[46px] rounded-xl text-[15px] font-bold flex items-center justify-center gap-2 transition-all mb-5
                  ${status === "loading"
                    ...
                    : "bg-[#ffc107] hover:bg-[#e6a800] active:scale-[0.98]"
                  } text-[#1a1a1a]`}
              >
                {status === "loading" ? (
          ...
          {page === "register" && status !== "sent" && (
            <p className="text-center text-xs text-gray-400 leading-relaxed">
              ...
              <a href="#" className="text-[#92400e] hover:underline">Terms</a>{" "}
              &amp;{" "}
              <a href="#" className="text-[#92400e] hover:underline">Privacy Policy</a>
            </p>
          )}
        </div>
      </div>
