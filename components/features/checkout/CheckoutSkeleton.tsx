...
function OrderSummarySkeleton() {
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm animate-pulse">
      {/* Title */}
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 pb-8 border-b border-gray-100">
        <div className="w-full md:w-56 shrink-0 bg-slate-50 border border-slate-100 rounded-2xl p-4 h-36 flex items-center justify-center">
          <div className="w-full h-full rounded-xl bg-gray-200" />
        </div>
        <div className="flex-grow w-full space-y-3">
          <div className="h-7 w-3/4 rounded bg-gray-200" />
          <div className="h-5 w-32 rounded-md bg-yellow-50" />
          ...
          <div className="h-10 w-32 rounded-lg bg-gray-100 mt-6" />
        </div>
      </div>

      {/* Date timeline */}
      <div className="py-8 border-b border-gray-100">
        <div className="h-4 w-28 rounded bg-gray-200 mb-5" />
        <div className="bg-slate-50 border border-slate-100 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="h-7 w-24 rounded-full bg-gray-200 my-2 md:my-0" />
...
function FareDetailsSkeleton() {
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm animate-pulse">
      ...
      {/* Button skeleton */}
      <div className="w-full rounded-xl bg-gray-200 h-[52px]" />
      ...
      <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col items-center gap-3">
        ...
        <div className="flex gap-2">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="h-7 w-10 rounded bg-gray-100" />
          ))}
        </div>
      </div>
    </div>
