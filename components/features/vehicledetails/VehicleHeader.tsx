export default function VehicleHeader() {
  return (
    <div className="bg-gray-10 rounded-md p-8 border border-gray-200 flex flex-col items-center relative mb-8">
      ...
      <img
        ...
        alt="Yamaha Fascino"
        className="w-full max-w-md h-auto mix-blend-multiply mb-6 p-10"
      />
