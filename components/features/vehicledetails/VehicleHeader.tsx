export default function VehicleHeader() {
  return (
    <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 flex flex-col items-center relative">
      ...
      <img
        ...
        alt="Yamaha Fascino"
        className="w-full max-w-md h-auto mix-blend-multiply mb-6"
      />
