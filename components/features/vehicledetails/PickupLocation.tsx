...
export default function PickupLocation({ location }: Props) {
  ...
  const mapUrl = `https://maps.geoapify.com/v1/staticmap?style=osm-bright&width=800&height=400&center=lonlat:${location.longitude},${location.latitude}&zoom=14&marker=lonlat:${location.longitude},${location.latitude};color:%23ff0000;size:large&apiKey=${apiKey}`;
