  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
      ...
      <div className="flex flex-col items-center px-8 py-10 border-b border-gray-50 bg-gradient-to-b from-amber-50/70 to-white">
        <div className="w-20 h-20 rounded-full bg-amber-100 border-4 border-white shadow-md flex items-center justify-center mb-4">
          <svg
            className="w-11 h-11 text-brand-yellow"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
