...
import type { Offer } from "@/types/search.types";

// ── Icon map — backend icon_type → SVG ───────────────────────────────

function OfferIcon({
  type,
  featured,
}: {
  type: Offer["icon_type"];
  featured: boolean;
}) {
  const cls = `w-6 h-6 ${featured ? "" : "text-gray-500"}`;
                ...
                {offer.is_featured ? (
                  <div>
                    <div className="flex items-center space-x-2 mb-2">
                      <OfferIcon type={offer.icon_type} featured />
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <OfferIcon type={offer.icon_type} featured={false} />
                    </div>
