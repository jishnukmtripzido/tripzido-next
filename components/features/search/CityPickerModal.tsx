...
const CityCard = memo(function CityCard({
  ...
  return (
    <button
      ...
      onMouseEnter={() => onMouseEnter(city.id)}
...
export default function CityPickerModal({
  ...
  return (
    <>
      ...
      >
        <div className="animate-slide-up sm:animate-scale-in pointer-events-auto relative w-full h-[100dvh] sm:h-auto bg-white sm:rounded-2xl sm:max-w-4xl sm:mx-6 sm:max-h-[85vh] flex flex-col overflow-hidden sm:shadow-2xl">
          {/* ── Header ── */}
          ...
          >
            ...
            {!loading && error && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <svg
                  className="w-12 h-12 text-red-200 mb-3"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
