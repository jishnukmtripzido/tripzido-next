...
const OFFERS = [
  {
    ...
    description: <>Get Flat <strong>Rs. 100 OFF</strong> on orders above Rs. 2,000</>,
  ...
  },
  {
    ...
    icon: <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" /></svg>,
  },
  {
    id: "4",
              ...
              >
                {offer.featured ? (
                  <div>
                    ...
                    <p className="text-xs font-normal leading-relaxed">{offer.description}</p>
                  </div>
                ) : (
                  <div>
                    ...
                    <p className="text-gray-700 text-xs font-normal">{offer.description}</p>
                  </div>
                )}
              </div>
            ))}
