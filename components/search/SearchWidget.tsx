...
export default function SearchWidget({ cities, citiesError }: SearchWidgetProps) {
  ...
  async function handleSearch(e: React.FormEvent) {
    ...
    try {
      ...
      // Store results and navigate — or pass via URL params
          ...
          <div className="bg-white rounded-xl shadow-xl p-4 border border-gray-400">
            <div className="flex flex-wrap md:flex-nowrap items-end gap-2">
              ...
              <div className="relative w-full md:flex-1 min-w-0">
                ...
                <TriggerButton onClick={() => setOpenModal("city")} disabled={!!citiesError}>
                ...
                {errors.city_id && <p className="text-xs text-red-500 mt-1 ml-1">{errors.city_id}</p>}
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 w-full md:contents">
                ...
                <div className="relative w-full md:w-[130px] md:shrink-0">
                  ...
                  {errors.pickup_datetime && <p className="text-xs text-red-500 mt-1 ml-1">{errors.pickup_datetime}</p>}
                </div>
                ...
                <div className="relative w-full md:w-[130px] md:shrink-0">
                  ...
                  {errors.dropoff_datetime && <p className="text-xs text-red-500 mt-1 ml-1">{errors.dropoff_datetime}</p>}
                </div>
...
function TriggerButton({ onClick, children, disabled = false }: { onClick: () => void; children: React.ReactNode; disabled?: boolean; }) {
  return (
    <button
      type="button"
      onClick={onClick}
